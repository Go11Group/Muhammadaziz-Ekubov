...
type WeatherServiceClient interface {
	GetCurrentWeather(ctx context.Context, in *GCWRequest, opts ...grpc.CallOption) (*GCWResponse, error)
	GetWeatherForecast(ctx context.Context, in *GWFRequest, opts ...grpc.CallOption) (*GWFResponse, error)
	ReportWeatherCondition(ctx context.Context, in *RWCRequest, opts ...grpc.CallOption) (*RWSResponse, error)
}
...
func (c *weatherServiceClient) GetCurrentWeather(ctx context.Context, in *GCWRequest, opts ...grpc.CallOption) (*GCWResponse, error) {
	out := new(GCWResponse)
	err := c.cc.Invoke(ctx, "/genproto.WeatherService/GetCurrentWeather", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *weatherServiceClient) GetWeatherForecast(ctx context.Context, in *GWFRequest, opts ...grpc.CallOption) (*GWFResponse, error) {
	out := new(GWFResponse)
	err := c.cc.Invoke(ctx, "/genproto.WeatherService/GetWeatherForecast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *weatherServiceClient) ReportWeatherCondition(ctx context.Context, in *RWCRequest, opts ...grpc.CallOption) (*RWSResponse, error) {
	out := new(RWSResponse)
	err := c.cc.Invoke(ctx, "/genproto.WeatherService/ReportWeatherCondition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	GetCurrentWeather(context.Context, *GCWRequest) (*GCWResponse, error)
	GetWeatherForecast(context.Context, *GWFRequest) (*GWFResponse, error)
	ReportWeatherCondition(context.Context, *RWCRequest) (*RWSResponse, error)
...
func (UnimplementedWeatherServiceServer) GetCurrentWeather(context.Context, *GCWRequest) (*GCWResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCurrentWeather not implemented")
}
func (UnimplementedWeatherServiceServer) GetWeatherForecast(context.Context, *GWFRequest) (*GWFResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWeatherForecast not implemented")
}
func (UnimplementedWeatherServiceServer) ReportWeatherCondition(context.Context, *RWCRequest) (*RWSResponse, error) {
...
func _WeatherService_GetCurrentWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.WeatherService/GetCurrentWeather",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetCurrentWeather(ctx, req.(*GCWRequest))
	}
...
func _WeatherService_GetWeatherForecast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.WeatherService/GetWeatherForecast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetWeatherForecast(ctx, req.(*GWFRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WeatherService_ReportWeatherCondition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.WeatherService/ReportWeatherCondition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ReportWeatherCondition(ctx, req.(*RWCRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "genproto.WeatherService",
